# git.md — Git 基础采集（所有 Gate 的前置，v1.0）
...
bash scripts/fingerprint-tree.sh <repo>   # v1.0：Exact Working Tree Fingerprint（含 untracked）
```

> **v1.0 快照语义**：`git write-tree` 只反映 index/tree，**不包含 untracked**。
